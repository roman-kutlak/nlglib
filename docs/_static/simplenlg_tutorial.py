...
from nlglib.lexicon import DefaultLexicon
...
def coordinations():
    subject1 = NP('Mary')
    subject2 = NP('your', 'giraffe')  # FIXME: simplenlg changes 'your' to 'it'
...
def coordinated_clause():
    ...
    print(realise(s3))
    print(realise(s1 + s2))
    print(realise(c))  # FIXME: No orthography on coordinations
