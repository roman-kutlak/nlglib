...
class WordElement(NLGElement):
    ...
    def __init__(self, base_form='', category='', id='', lexicon='', realisation=''):
...
class InflectedWordElement(NLGElement):
    ...
    def realise_morphology(self):
        ...
        if self.non_morph:
            ...
            realised_element.features[DISCOURSE_FUNCTION] = self.features[DISCOURSE_FUNCTION]
        else:
            if self.base_form:
            ...
            if self.category == NOUN:
                ...
                realised_element = rules.morph_pronoun(self)
