...
class TestSimplenlgTutorial:
    ...
    # def test_simple_sentence(self, lexicon_en):
    #     realiser = Realiser(lexicon_en)
    #     expected = 'Mary chases the monkey.'
    #     c = Clause(lexicon=lexicon_en)
    #     mary = NounPhraseElement(lexicon_en)
    #     mary.noun = lexicon_en.first('Mary', category=category.NOUN).inflex(gender=f.gender.FEMININE)
    #     c.subjects = [mary]
    #     chase = VerbPhraseElement(lexicon=lexicon_en)
    #     chase.verb = lexicon_en.first('chase', category=category.VERB)
    #     monkey = NounPhraseElement(lexicon=lexicon_en)
    #     monkey.noun = lexicon_en.first('monkey', category=category.NOUN)
    #     monkey.specifier = lexicon_en.first('the', category=category.DETERMINER)
    #     chase.object = monkey
